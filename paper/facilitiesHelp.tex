...
\includegraphics[width=0.78\textwidth]{capability_grades}
...
\begin{figure}[H]\centering
\includegraphics[width=0.7\textwidth]{ml_feature_importance}
...
\begin{figure}[H]\centering
\includegraphics[width=0.85\textwidth]{corr_heatmap}
...
\begin{figure}[H]\centering
\includegraphics[width=0.62\textwidth]{causal_dag}
...
\begin{figure}[H]\centering
\includegraphics[width=0.83\textwidth]{causal_effects}
...
\begin{figure}[H]\centering
\includegraphics[width=0.83\textwidth]{causal_scatters}
...
\includegraphics[width=\textwidth]{gam_quantile}
\caption{GAM + quantile regression.}\label{fig:gam}
\end{minipage}\hfill
\begin{minipage}{0.49\textwidth}\centering
\includegraphics[width=\textwidth]{gnn_vs_baseline}
