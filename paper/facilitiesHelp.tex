...
Roadmap: 2SFCA accessibility scoring to weight reachable supply within a travel radius; and \emph{last-mile} integrations that turn a verdict into an action---open or route to a facility in Google Maps, place a call or WhatsApp message to it, and email a shortlist or referral letter to a colleague---so a trusted recommendation becomes a next step in one tap.
